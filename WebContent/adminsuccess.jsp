...
<div class="container">
<h2 style="font-family:  monospace;color:  cornflowerblue;">Choose an option</h2><br>

<a href="studreg.jsp"><button type="button" class="btn btn-info" style="width: 15%;">Add Student Details</button></a>
<br><br><br>
<a href="teacherreg.jsp"><button type="button" class="btn btn-info" style="width: 15%;">Add Teacher Details</button></a>

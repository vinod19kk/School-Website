...
<div class="container">
<h2 style="font-family:  monospace;color:  cornflowerblue;">Admin Login  Here</h2><br>
...
<!-- <a href="adminreg.jsp"><button type="submit" class="btn btn-info" style="width: 12%;">Sign Up</button></a> -->
</div>
    </body>
</html>